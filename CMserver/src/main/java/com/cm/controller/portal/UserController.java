...
public class UserController {
    ...
    @ResponseBody //自动通过spring mvc的Json插件将返回值序列化成Json格式
    ...
    @ResponseBody
    public ServerResponse<String> checkValid(String str,String type){ return iUserService.checkValid(str,type); }
